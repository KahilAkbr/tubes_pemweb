...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST["submit"])) {
        ...
        // Generate auto-increment value for id_jam_kerja
        $id_jam_kerja = generateAutoIncrementId("jam_kerja", "id_jam_kerja");

        // Insert data into the database
        $shiftHoursString = implode(",", $shiftHours);
        $pembagianKaryawan = json_encode($pembagianKaryawan);

        $sql = "INSERT INTO jam_kerja (id_jam_kerja, nama_shift, jumlah_shift, jam_shift, pembagian_karyawan) 
                VALUES ('$id_jam_kerja', '$namaShift','$shiftCount', '$shiftHoursString', '$karyawanStringFormat')";

        if ($conn->query($sql) === TRUE) {
            // Print the names in an alert
...
// Function to generate auto-increment value for a specific table and column
function generateAutoIncrementId($table, $column) {
    global $conn;

    // Get the last inserted ID in the specified table
                ...
                <main role="main" class="col-md-10 ml-sm-auto" style="background-color:whitesmoke">
                    <form action="" method="post" enctype="multipart/form-data" name="karyawanForm">
                        <div id="shiftNameForm">
                            <div class="container">
                                <div class="text-center mb-4">
                                    <h3 style="margin-top: 35px">Tambah Jadwal Kerja</h3>
                        ...
                        <div id="shiftHoursForm" style="display:none;">
                            <div class="container">
                                ...
                                <div class="text-center" style="padding-top:20px">
                                    <a href="#" class="btn btn-dark btn-secondary" id="btnBackToShiftForm"
                                        style="color:#FFF6E0">Back</a>
                                    <button type="button" class="btn btn-dark btn-success" id="btnAddKaryawanForm"
                                        style="color:#FFF6E0">Continue</button>
                                    <br><br>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="karyawanForm" style="display:none;">
                            ...
                            <div class="container">
                                <div class="text-center mb-4">
                                    <h3 style="margin-top: 35px">Tambah Karyawan ke Shift</h3>
                                </div>
                                ...
                                <div class="text-center">
                                    <a href="#" class="btn btn-dark btn-secondary" id="btnBackToShiftHoursForm"
                                        style="color:#FFF6E0">Kembali</a>
        ...
        function displayKaryawanDetails() {
            ...
            for (let i = 1; i <= shiftCountInput.value; i++) {
                ...
                seeDetails.innerHTML = `
                    ...
                    <button type="button"class="btn btn-dark btn-sm" id="btnTambahKaryawan${i}" onclick="tambahKaryawan(${i})" style="color:#FFF6E0">Tambah</button>
