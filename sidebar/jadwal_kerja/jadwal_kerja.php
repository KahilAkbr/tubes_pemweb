...
if (isset($_GET['id_jam_kerja']) && !empty($_GET['id_jam_kerja'])) {
    $id_jam_kerja = $_GET['id_jam_kerja'];

    $sql = "DELETE FROM jam_kerja WHERE id_jam_kerja = '$id_jam_kerja'";
...
<body>
                ...
                <main role="main" class="col-md-10 ml-sm-auto" style="background-color:whitesmoke">
                    ...
                    <div class="container" style="padding-top:10px">
                        <div class="text-center mb-4">
                            <h3 style="margin-top: 10px;font-size:35px">Jadwal Kerja</h3>
                            <p class="text-muted" style="font-size:15px">Kelola dan Lihat Jadwal Kerja Disini!</p>
                        </div>
                    </div>
                    <a href="tambah_jadwal_kerja.php" class="btn btn-dark btn-primary"
                        style="margin-bottom:10px;margin-top: 10px;color:#FFF6E0">Tambah Jadwal Kerja</a>
                            ...
                            <div class="hideShift">
                                <div class="black-box mx-2 my-2 d-flex flex-column justify-content-between">
                                    ...
                                    <div class="btn-group d-flex justify-content-center mt-3">
                                        ...
                                        <a href="manage_jadwal_kerja/view_jadwal_kerja.php?id_jam_kerja=<?php echo $id_jam_kerja; ?>"
                                        ...
                                        <a class="btn btn-dark btn-primary" style="background-color:#FFF6E0;color:black"
                                            href="manage_jadwal_kerja/update_jadwal_kerja.php?id_jam_kerja=<?php echo $id_jam_kerja; ?>">Update</a>
                                        <a class="btn btn-dark btn-primary" style="background-color:#FFF6E0;color:black"
                                            href="#" data-id="<?php echo $row['id_jam_kerja']; ?>"
                                            onclick="delete_jadwal(event)">Hapus</a>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    function delete_jadwal(event) {
        ...
        Swal.fire({
            title: 'Apakah Anda Yakin?',
            text: "Jadwal Kerja ini akan dihapus. Tindakan ini tidak dapat diurungkan.",
            icon: 'warning',
            showCancelButton: true,
            ...
            if (result.isConfirmed) {} else if (result.dismiss === Swal.DismissReason.cancel) {
                window.location.href = `jadwal_kerja.php?id_jam_kerja=${karyawanId}`;
            }
        });
    }
    document.addEventListener("DOMContentLoaded", function() {
        ...
        function successDeleteAlert() {
            Swal.fire(
                'Jadwal Terhapus!',
                'Jadwal kerja berhasil terhapus!.',
                'success'
            );
        }
    });
