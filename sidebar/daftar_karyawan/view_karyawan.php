                ...
                <main role="main" class="col-md-10 ml-sm-auto" style="background-color:whitesmoke">
                    ...
                    <div class="container">
                        <div class="text-center mb-4">
                            <h3 style="margin-top: 10px">View Data</h3>
                            <p class="text-muted">View Data Karyawan</p>
                        </div>
                    </div>
                        ...
                        <form action="" method="post" enctype="multipart/form-data"
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="no_ktp" placeholder="NO KTP"
                                        maxlength="16" disabled value="<?php echo $no_ktp; ?>">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="form-label">Nama:</label>
                                    <input type="text" class="form-control" name="nama" placeholder="Nama"
                                        maxlength="100" disabled value="<?php echo $nama; ?>">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 mb-3">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="email" class="form-control" name="email" placeholder="Email"
                                        maxlength="100" disabled value="<?php echo $email; ?>">
                                </div>
                                <div class="col-md-6 mb-3">
                            ...
                            <div class="text-center">
                                ...
                                <button type="button" class="btn btn-dark btn-secondary" id="btnCancel"
                                    style="background-color:#606C38">Back</button>
                                <br><br>
                            </div>
                        </form>
                    </div>
